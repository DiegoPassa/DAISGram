...
void show_help() {
    ...
    printf("\targ 5: file to compare with the result\n");
    printf(
        "\targ 6: Diversi significati in funzione dell'operazione (default 3):\n"
        "\t\t- [smooth]: kernel size \n"
        "\t\t- [brighten]: valore bright per aumentare la luminosità \n"
        "\t\t\n");
    printf(
        "\targ 7: Diversi significati in funzione dell'operazione (default 1.0):\n"
